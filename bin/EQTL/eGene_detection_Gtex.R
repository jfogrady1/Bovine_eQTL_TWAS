...
head(eqtl)
# Can't believe they didn't upload the column names, very poor
colnames(eqtl) <- c("phenotype_id", "num_var", "beta_shape1", "beta_shape2", "true_df", "variant_id", "start_distance", "pval_nominal", "slope", "pval_perm", "pval_beta")
