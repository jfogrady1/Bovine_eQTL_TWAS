...
vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]] <- lapply(vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]], function(x) sub("0\\|0:.*", paste0("0"), x))
vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]] <- lapply(vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]], function(x) sub("0\\|1:.*", paste0("1"), x))
vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]] <- lapply(vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]], function(x) sub("1\\|0:.*", paste0("1"), x))
vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]] <- lapply(vcf_reac[,colnames(vcf_reac)[10:length(colnames(vcf_rec))]], function(x) sub("1\\|1:.*", paste0("2"), x))


vcf_reac_dom <- vcf_reac
head(vcf_reac)
vcf_reac_dom[,colnames(vcf_reac_dom)[10:length(colnames(vcf_rec))]] <- lapply(vcf_reac_dom[,colnames(vcf_reac_dom)[10:length(colnames(vcf_rec))]], function(x) sub("2", paste0("0"), x))
